...
public class MapPractice3 {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object>[] people = new Map[5];
        ...
        // Increase 2nd persons salary by 10000 dollars

        people[1].replace("salary", (Integer) people[1].get("salary")+10000);
        ...
        for (Map<String, Object> person : people){
            ...
            if (((Integer)person.get("salary")) < 100000){
                System.out.println(person.get("name")+(" : $"+person.get("salary")));
            }
